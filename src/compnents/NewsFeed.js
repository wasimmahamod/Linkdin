...
const NewsFeed = () => {
  ...
  return (
    ...
    <div>
        ...
        <input onChange={handlePostBox} className='w-full py-7 placeholder:font-nunito text-lg placeholder:text-[#D1D1D1] px-5' placeholder='What’s on your mind?' value={textPost}/>
